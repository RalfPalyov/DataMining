...
class JUnitTestCases(unittest.TestCase):
    ...
    __featureMatrix     = [[4, 2, 1, 0, 20, 15, 3, 0, 6], [29, 12, 2, 5, 70, 5, 2, 0, 6], [9, 1, 23, 12, 23, 13, 29, 6, 9]]
    __weightMatrix      = [[12, 10, 4], [6, 15, 7], [3, 3, 10]]
    __listOfAllWords    = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i']
    __listOfAllTitles   = ['titel a', 'titel b', 'titel c']
    ## Setup- Function ##
    def setUp(self):
        pass
    ...
    def test_showFeatures_offline(self):
        newsfeatures.showfeatures(self.__weightMatrix, self.__featureMatrix, self.__listOfAllTitles, self.__listOfAllWords)
